...
public class ApplicationMain {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * **** 아래(실행결과) **** 상품 정보: 코드-P-1, 마우스, 가격-15000원, 재고-28개 상품 정보: 코드-P-3, 볼펜,
		 * 가격-2900원, 재고-90개 상품 정보: 코드-P-3, 볼펜, 가격-2900원, 재고-85개 ------------전체 상품 정보 출력
		 * 시작------------ 상품 정보: 코드-P-1, 마우스, 가격-15000원, 재고-28개 상품 정보: 코드-P-2, 자바의 정석,
		 * 가격-38000원, 재고-50개 상품 정보: 코드-P-3, 볼펜, 가격-2900원, 재고-85개 상품 정보: 코드-P-4, 키보드,
		 * 가격-51000원, 재고-75개 ------------전체 상품 정보 출력 종료------------ ------------전체 주문 정보
		 * 출력 시작------------ 주문 정보: 주문번호-1, 주문고객명-홍길동, 주문상품-P-1, 주문수량-2, 취소여부-정상 주문 정보:
